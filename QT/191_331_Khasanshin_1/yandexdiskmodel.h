#ifndef YANDEXDISKMODEL_H
#define YANDEXDISKMODEL_H
...
class yandexdiskmodel: public QAbstractListModel
...
public:
    ...
    explicit yandexdiskmodel(QObject *parent = nullptr);
